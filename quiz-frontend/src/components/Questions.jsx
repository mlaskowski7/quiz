...
const Question = ({technology, question, difficulty, o1, o2, o3}) =>(
  <div className="flex flex-col gap-3 bg-white justify-start text-left text-black p-8 rounded-xl w-[30%] h-[100%] border-b-8 border-white hover:border-b-[#7E662A] transition-all duration-300 ease-in-out">
